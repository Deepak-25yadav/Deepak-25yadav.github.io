...
const About = () => {
  return (
    <Box border = '2px solid rgb(1, 16, 27)' h = '100vh' id="about" className = "about section" mb = '40px'>
        ...
        <Text mt = '50px' fontSize={'20'}>Hello 👋 Myself Deepak</Text>

        <Box className = {style.aboutme} color = 'black' p = {{base : '8','486px' : '10'}} borderRadius={'10px'} bg = 'green.300' w = {{base : '100%','410px' : '300px','486px':'400px'}} m = 'auto' mt = '20px'>
